...
# 偏置初始化
hidden_bias0 = np.random.randn(400)
hidden_bias1 = np.random.randn(256)
hidden_bias2 = np.random.randn(100)
hidden_bias3 = np.random.randn(64)
...
np.save("./minist_data/hidden_bias3.npy", hidden_bias3)
np.save("./minist_data/output_bias.npy", output_bias)

hidden_parameter0 = np.random.randn(784, 400) * (1.0 / np.sqrt(400))
hidden_parameter1 = np.random.randn(400, 256) * (1.0 / np.sqrt(256))
hidden_parameter2 = np.random.randn(256, 100) * (1.0 / np.sqrt(100))
hidden_parameter3 = np.random.randn(100, 64) * (1.0 / np.sqrt(64))
